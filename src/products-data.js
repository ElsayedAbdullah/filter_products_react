const products = [
  ...
  },
  {
    ...
    price: 695,
    description: "From our Legends Collection, the Naga was inspired by the mythical water dragon that protects.",
    category: "jewelery",
  ...
  },
  {
    ...
    price: 168,
    description: "Satisfaction Guaranteed. Return or exchange any order within 30 days.Designed and sold.",
    category: "jewelery",
  ...
  },
  {
    ...
    price: 39.99,
    description: "Lightweight perfet for trip or casual wear---Long sleeve with hooded, adjustable drawstring.",
    category: "women's clothing",
  ...
  },
  {
    ...
    price: 9.85,
    description: "95% RAYON 5% SPANDEX, Made in USA or Imported, Do Not Bleach, Lightweight fabric with great.",
    category: "women's clothing",
